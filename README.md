...
from core.non_ideal_closed_cycle_layer import apply_combined_offsets
...
| [`core/non_ideal_closed_cycle_layer.py`](core/non_ideal_closed_cycle_layer.py) | 非理想层：有向组、深度、`apply_combined_offsets` |
...
全量：`pytest tests/ -q`（共 3 个用例）。也可直接运行：
