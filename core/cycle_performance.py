...
def resolve_performance_context(
    ...
    *,
    ...
    if ni is not None and ni.nodes is not None:
        return PerformanceContext(simplified=simplified, nodes=ni.nodes, source="non_ideal")

    return PerformanceContext(simplified=simplified, nodes=layer.nodes, source="ideal")
